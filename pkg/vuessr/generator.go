...
func genComponentRenderFunc(c *Compiler, pkgName, name string, file string, srcHash string) string {
...
func GenAllFile(src, desc string, pkg string) (err error) {
	...
	for _, v := range vs {
		...
		newCodeStr := genComponentRenderFunc(c, pkgName, v.ComponentName, v.Path, srcHash)
