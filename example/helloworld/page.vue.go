...
// src_hash:0e10200887314dd2e123ced7d82ca36c
...
func (r *Render) Component_page(options *Options) string {
	...
	_ = this
	return "<html lang=\"zh\"><head><meta charset=\"UTF-8\"></meta><title>" + interfaceToStr(lookInterface(this, "title"), true) + "</title></head><body><h1 style=\"text-align: center; margin-top: 100px; \">" + interfaceToStr(lookInterface(this, "title")) + "</h1>" + r.Component_info(&Options{
